...
<img src="assets/demo.gif" alt="Impact Report Dashboard: the flow on a good run, then the same flow with Break it pressed — every failure path lit in red" width="100%">
